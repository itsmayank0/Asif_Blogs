...
ALLOWED_HOSTS = ['*', 'asifblogs.azurewebsites.net']
...
# tinymce intrigration
TINYMCE_JS_URL = os.path.join(
    STATIC_URL, "js/tinymce/js/tinymce/tinymce.min.js")
TINYMCE_JS_ROOT = os.path.join(STATIC_URL, "js/tinymce/js/tinymce")
